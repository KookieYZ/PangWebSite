                                ...
                                <table class="table">
                                    ...
                                    @foreach ($themes as $theme)
                                        <tbody class="customtable">
                                            <tr>
                                                <th>
                                                    <a href="{{ route('theme.edit', $theme) }}"><i
                                                            class="far fa-edit" title="更改资料"></i></a>
                                                    <a href="{{ route('theme.show', $theme) }}"><i
                                                            class="fas fa-eye" title="查看资料"></i></a>
                                                    <form>
                                                </th>
                                                <td>{{ $theme->key }}</td>
                                                <td>
                                                    @if ($theme->id == 4)
                                                        <img src=" {{ asset($theme->value) }}" height="100"
                                                            width="300" style="border:solid">
                                                    @elseif ($theme->id == 5)
                                                        <img src=" {{ asset($theme->value) }}" height="100"
