...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="row">
            ...
            <h4 class="page-title">Edit Theme Setting</h4>
            </div>
        </div>
        </div>
        <!-- ============================================================== -->
        ...
        <div class="row">
            <div class="col-md-12">
            <div class="card">
                <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('theme.update', $themes->id) }}">
                    @csrf
                    @method('PATCH')
                <div class="card-body">
                    ...
                    @if ($themes->id == 1 || $themes->id == 2 || $themes->id == 3)
                        <div class="col-sm-9">
                            <input type="text" id="value" name="value" value="{{ old('value') ? old('value') : $themes->value }}" class="form-control color{{ $errors->has('value') ? ' is-invalid' : '' }}" data-control="hue" />
                    ...
                    @if ($themes->id == 6 || $themes->id == 7 || $themes->id == 8 || $themes->id == 9)
                        <div class="col-sm-9">
                            <input
                                ...
                                id="value" name="value" value="{{ old('value') ? old('value') : $themes->value }}" required
                            />
                            @if ($errors->has('value'))
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $errors->first('value') }}</strong>
