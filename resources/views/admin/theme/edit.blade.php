                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data"
                                action="{{ route('theme.update', $themes->id) }}">
                                @csrf
                                @method('PATCH')
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"
                                                ...
                                                id="key" name="key"
                                                value="{{ old('key') ? old('key') : $themes->key }}" required
                                                disabled />
                                            @if ($errors->has('key'))
                                    ...
                                    <div class="form-group row">
                                        <label for="value"
                                            class="col-sm-3 text-end control-label col-form-label">设置内容</label>
                                ...
                                <div class="border-top">
                                    <div class="card-body">
                                        ...
                                        <a href="{{ route('theme.index') }}" class="btn btn-primary"
                                            id="back">{{ __('返回') }}</a>
                                    </div>
                                </div>
                            </form>
