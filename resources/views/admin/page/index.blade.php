            ...
            <div class="col-12 d-flex no-block align-items-center">
              ...
              <div class="ms-auto text-end">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <a href="{{ route("page.create") }}"><button type="button" class="btn btn-primary">Create New</button></a>
                  </ol>
                </nav>
              </div>
            </div>
                ...
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody class="customtable">
                      <tr>
                        <th>
                          <a href="{{ route('page.edit', $page) }}"><i class="far fa-edit" title="Edit Page Details"></i></a>
                            <a href="{{ route('page.show', $page) }}"><i class="fas fa-eye" title="View Page Details"></i></a>

                            <form method="POST" action="{{ route('page.destroy', $page->id) }}" accept-charset="UTF-8" style="display:inline;" title="Delete Page">
                            {{ csrf_field() }}
                            @method('DELETE')
