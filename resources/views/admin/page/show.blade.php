            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="col-sm-9">
                        ...
                        placeholder="Title" required disabled
                        />
                        @if ($errors->has('title'))
                    ...
                    <div class="col-sm-9">
                        ...
                        placeholder="URL" required disabled style="max-height:300px"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-select" aria-label="" id="parent_id" name="parent_id" disabled>
                                @if ($page->parent_id)
                                    <option value="{{ $page->parent_id }}">{{ $page->parent_id }} - {{ $page->parent->title }}</option>
                                @endif
                            </select>
