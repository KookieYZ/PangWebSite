    ...
    <div class="page-wrapper">
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('page.update', $page->id) }}">
                    @csrf
                    @method('PATCH')
                <div class="card-body">
                    ...
                    <div class="col-sm-9">
                        ...
                        id="title" name="title" value="{{ old('title') ? old('title') : $page->title }}"
                    ...
                    <div class="col-sm-9">
                        ...
                        id="url" name="url" value="{{ old('url') ? old('url') : $page->url }}"
                        placeholder="URL" required style="max-height:300px"
                        >{{ old('url') ? old('url') : $page->url }}</textarea>
                        @if ($errors->has('url'))
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="col-sm-9">
                        ...
                        id="ranking" name="ranking" value="{{ old('ranking') ? old('ranking') : $page->ranking }}"
                        ...
                        <div class="col-sm-9">
                            <select class="form-select" aria-label="" id="parent_id" name="parent_id">
                                ...
                                @foreach ($pages as $page2)
                                    <option value="{{ $page2->id }}">{{ $page2->id }} - {{ $page2->title }}</option>
                                @endforeach
                                @if ($page->parent_id)
                                    <option value="{{ $page->parent_id }}" selected hidden>{{ $page->parent_id }} - {{ $page->parent->title }}</option>
                                @endif
                ...
                <div class="border-top">
                    ...
                    <a href="{{ route('page.index') }}" class="btn btn-primary" id="back">{{ __('Back') }}</a>
                    </div>
                </div>
                </form>
            </div>
