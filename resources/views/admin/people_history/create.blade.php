                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <input type="date"
                                        ...
                                        id="incident_date" name="incident_date" value="{{ old('incident_date') }}" placeholder="发生于"
                                        max="9999-12-31"/>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea type="text"
                                        ...
                                        name="description" value="{{ old('description') }}" placeholder="事件内容" 
                                ...
                                <select class="form-select" aria-label="" id="people_id" required
                                             ...
                                             <option value="" selected>---未选择---</option>
                                                @foreach ($pplNameArr as $ppl)
                                                    <option value="{{ $ppl->id}}" {{($ppl->id == $selectedPerson) ? 'selected' : ''}}>{{ $ppl->name }}</option>
                                                    @endforeach
                                            </select>
