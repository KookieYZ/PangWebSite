                    ...
                    <form class="form-horizontal">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <input type="text"
                                        class="form-control{{ $errors->has('history_name') ? ' is-invalid' : '' }}" id="title"
                                         name="history_name" value="{{ old('history_name') ? old('history_name') : $people_history->history_name }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <input type="date"
                                        class="form-control{{ $errors->has('incident_date') ? ' is-invalid' : '' }}" id="incident_date"
                                        title="incident_date" value="{{ old('incident_date') ? old('incident_date') : $people_history->incident_date }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                        ...
                                        style="max-height:300px"  rows="4" cols="50" disabled>{{ old('description') ? old('description') : $people_history->description }}</textarea>
                            ...
                            <div class="form-group row">
                             ...
                             {{-- <video id="myVideo"  width="400" height="300">
                                <source src="{{ asset('assets/videos/people_history/' . $people_history->media_path)}}" type="video/mp4"> --}}
                               <iframe class="embed-responsive-item  video-blog" width="400" height="300"
                                src="{{ asset('assets/videos/people_history/' . $people_history->media_path)}}" title="URL video player"
                             ...
                             {{-- </video> --}}
                                ...
                                <div class="col-sm-2">
                                <select class="form-select" aria-label="" id="people_id" disabled
                                                name="people_id">
