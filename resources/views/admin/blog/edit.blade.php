...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="row">
            <div class="col-md-12">
            <div class="card">
                <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('blog.update', $blog->id) }}">
                    @csrf
                    @method('PATCH')
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        >
                        <div class="col-sm-9">
                            <select class="form-select" aria-label="" id="media_type" name="media_type" required>
                                @if ($blog->media_type == 'Image')
                                    <option value="">---Selected---</option>
                                    <option value="{{ $blog->media_type }}" selected>Image</option>
                                    <option value="Video">Video</option>
                                @elseif ($blog->media_type == 'Video')
                                    <option value="">---Selected---</option>
                                    <option value="Image">Image</option>
                                    <option value="{{ $blog->media_type }}" selected>Video</option>
                                @endif
                            </select>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            id="media_path" name="media_path" value="{{ old('media_path') ? old('media_path') : $blog->media_path }}"
                            placeholder="Media Path" required
                            />
                    ...
                    <div class="col-sm-9">
                        ...
                        id="description" name="description" value="{{ old('description') ? old('description') : $blog->description }}"
                        placeholder="Description" style="max-height:300px" required
                        >{{ old('description') ? old('description') : $blog->description }}</textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            id="year" name="year" value="{{ old('year') ? old('year') : $blog->year }}"
                            ...
                            <select class="form-select" aria-label="" id="page_id" name="page_id">
                                ...
                                @if ($blog->page_id)
                                    @foreach ($blogs as $blogg)
                                        <option value="{{ $blog->page_id }}" selected >{{ $blog->page_id }} - {{ $blogg->title }}</option>
                                    @endforeach
                                @endif
                    ...
                    >
                    <div class="col-sm-9">
                        <input type="checkbox" class="form-check-input" name="is_publish" id="is_publish" value="1" {{  ($blog->is_publish == 1 ? ' checked' : '') }}>
                    </div>
                    </div>
                ...
                <div class="border-top">
                    ...
                    <a href="{{ route('blog.index') }}" class="btn btn-primary" id="back">{{ __('Back') }}</a>
                    </div>
                </div>
                </form>
            </div>
