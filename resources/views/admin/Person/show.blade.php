                    ...
                    {{-- <form class="form-horizontal" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                        ...
                                        value="{{ old('spouse_name') ? old('spouse_name') : $value }}" disabled /><br />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <div class="custom-file">
                                        ...
                                        <img src=" {{ asset('image/avatar/' . $value) }}" height="130" width="130"
                        ...
                        <div class="border-top">
                            <div class="card-body">
                                ...
                                <a href="{{ route('relationship.index') }}" class="btn btn-primary" id="back">{{
                                    __('返回') }}</a>
                            </div>
                        </div>
                    </form>
