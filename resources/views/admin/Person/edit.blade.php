                    ...
                    <form class="form-horizontal" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input list="parent" type="text" name="parent" class="form-control"  value={{$parent_name}}>
                                    ...
                                    {{-- <div class="dropdown">
                                        ...
                                        <ul id="parent_id_menu" class="dropdown-menu">
                                            @foreach ($persons as $per)
                                            <li value="{{$per->id}}" onclick="picked('{{ $per->name }}')">
                                                {{ $per->id }} - {{ $per->name }}
                                            </li>
                                            @endforeach
                                        </ul>
