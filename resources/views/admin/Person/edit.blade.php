...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="row">
            ...
            <h4 class="page-title">Edit Relationship</h4>
            </div>
        </div>
        </div>
        <!-- ============================================================== -->
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('relationship.update', $person->id) }}">
                @csrf
                @method('PATCH')
                <div class="card-body">
                    ...
                    <div class="col-sm-9">
                        ...
                        placeholder="No spouse found" value="{{ old('spouse_name') ? old('spouse_name') : $person->spouse_name }}"
                        />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="custom-file">
                            ...
                            style="border:solid" id="spouse_display">
                        </div>
