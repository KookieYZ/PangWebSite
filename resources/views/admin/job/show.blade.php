                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                        ...
                                        style="max-height:300px"  rows="4" cols="50" disabled>{{ old('description') ? old('description') : $job->description }}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">                                   
                                        ...
                                        style="max-height:300px"  rows="4" cols="50" disabled>{{ old('background') ? old('background') : $job->background }}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                        ...
                                        style="max-height:300px"  rows="4" cols="50" disabled>{{ old('address') ? old('address') : $job->address }}</textarea>
