                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <input type="text"
                                        ...
                                        name="name" value="{{ old('name') }}" placeholder="在此输出商业名称" required />
                                    @if ($errors->has('name'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea type="text"
                                        ...
                                        name="description" value="{{ old('description') }}" placeholder="商业内容" 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                        ...
                                        name="background" value="{{ old('background') }}" placeholder="商业背景" 
                                        style="max-height:300px" rows="4" cols="50" ></textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea type="text"
                                        ...
                                        name="address" value="{{ old('address') }}" placeholder="商业地址" 
                                        style="max-height:300px" rows="4" cols="50" >
                                    </textarea>
