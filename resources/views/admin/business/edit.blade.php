            ...
            <div class="card">
                ...
                <form class="form-horizontal" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="category"
                                class="col-sm-3 text-end control-label col-form-label">商业种类</label>
                            <div class="col-sm-2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea type="text"
                                    ...
                                    id="description" name="description" placeholder="商业内容" style="max-height:300px"
                                    rows="4"
                                    cols="50">{{ old('description') ? old('description') : $business->description }}</textarea>
                        ...
                        <div class="form-group row">
                            <label for="background"
                                class="col-sm-3 text-end control-label col-form-label">商业背景</label>
                            <div class="col-sm-9">
                                <textarea type="text"
                                    class="form-control{{ $errors->has('background') ? ' is-invalid' : '' }}"
                                    id="background" name="background" placeholder="商业背景" style="max-height:300px"
                                    rows="4"
                                    cols="50">{{ old('background') ? old('background') : $business->background }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea type="text"
                                    ...
                                    id="address" name="address" placeholder="商业地址" style="max-height:300px" rows="4"
                                    cols="50">{{ old('address') ? old('address') : $business->address }}</textarea>
                    ...
                    <div class="border-top">
                        <div class="card-body">
                            ...
                            <a href="{{ route('business.index') }}" class="btn btn-primary" id="back">{{ __('返回') }}</a>
                        </div>
                    </div>
                </form>
            </div>
