        ...
        <div class="container">
            <form action="{{ route('search.index') }}" method="GET">
                ...
                <div class="row d-flex justify-content-center align-items-center p-3">          
                    <div class="col-9">
                        <input type="text" id="search_text" name="search_text" class="form-control search-slt border border-dark" value="{{ request('search_text') }}" style="border-radius: 20px" placeholder="輸入名字">
                    </div>                    
                    <div class="col-2">
                        <button type="submit" class="btn border border-dark text-black bg-white" style="border-radius: 20px">搜索</button>
                    </div>
                </div>
            </form>
        </div>
