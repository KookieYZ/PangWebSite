    ...
    <div class="row">
        ...
        <div class="col-10">
            ...
            <div class="d-flex align-items-center flex-column" id="scroll_container">
                ...
                <div class="w-auto d-flex justify-content-start m-2">
                      <img src=" {{ asset('image/people_history/' . $history->image_path) }}"
                       height="800" width="800" class="image-blog" style="border:solid">                                          
                </div>
                   <div class="w-auto d-flex justify-content-start m-2">
                            <iframe class="embed-responsive-item  video-blog" width="400" height="300"
                                src="{{ asset('assets/videos/people_history/' . $history->media_path)}}" title="URL video player"
