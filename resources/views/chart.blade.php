        ...
        data.addRows([
                                ...
                                '<div class="image d-flex flex-column justify-content-center align-items-center">'+ 
                                    '<div class="container bg-white text-dark mt-2" style="border-radius: 20px">'+
                                        '<div class="row d-flex justify-content-center p-2">'+
                                            '<div style="width: 100px;" class="mr-2">彭子平<br/>（第一代）</div>'+
                                            '<div style="width: 100px;" class="mr-2">彭子平</div>'+
                                            '<div style="width: 100px;" class="mr-2">彭子平</div>'+
                                            '<div style="width: 100px;" class="mr-2">彭子平</div>'+
                                        '</div>'+
                                    '</div>'+                   
          ...
          [{'v':'Childright', 'f':'<div class="image d-flex flex-row justify-content-center align-items-center">'+ 
                                ...
                                '<div class="container bg-white text-dark mt-2">'+
                                    ...
                                    '</div>'+          
                                '</div>'}, 'Parents', ''],
                                [{'v':'Suo', 'f':'<div class="image d-flex flex-row justify-content-center align-items-center">'+ 
                                    '<img class="mr-2" src="{{asset('assets/images/profile.jpg')}}" height="100" width="100" />'+ 
                                    '<img class="mr-2" src="{{asset('assets/images/profile.jpg')}}" height="100" width="100" />'+
                                    '<img class="mr-2" src="{{asset('assets/images/profile.jpg')}}" height="100" width="100" />'+
                                    '<img class="mr-2" src="{{asset('assets/images/profile.jpg')}}" height="100" width="100" />'+
          ...
          [{'v':'GrandChild1', 'f':'<div class="image d-flex flex-row justify-content-center align-items-center">'+ 
                                ...
                                '<div class="image d-flex flex-column justify-content-center align-items-center">'+ 
                                    '<div class="container bg-white text-dark mt-2" style="border-radius: 20px">'+
                                        '<div class="row d-flex justify-content-center p-2">'+
                                            '<div style="width: 100px;" class="">彭子平<br/>（第一代）</div>'+
                                        '</div>'+
                                    '</div>'+                   
                                '</div>'+
                                '<div class="container bg-white text-dark mt-2">'+
          ...
          [{'v':'GrandChild4', 'f':'<div class="image d-flex flex-row justify-content-center align-items-center">'+ 
                                ...
                                '<div class="image d-flex flex-column justify-content-center align-items-center">'+ 
                                    '<div class="container bg-white text-dark mt-2" style="border-radius: 20px">'+
                                        '<div class="row d-flex justify-content-center p-2">'+
                                            '<div style="width: 100px;" class="">彭子平<br/>（第一代）</div>'+
                                            '<div style="width: 100px;" class="">彭子平</div>'+
                                            '<div style="width: 100px;" class="">彭子平</div>'+
                                            '<div style="width: 100px;" class="">彭子平</div>'+
                                            '<div style="width: 100px;" class="">彭子平</div>'+
                                        '</div>'+
                                ...
                                '<div class="container bg-white text-dark mt-2">'+
                                    ...
                                    '</div>'+          
                                '</div>'}, 'Childright', ''],
                                [{'v':'GrandChild5', 'f':'<div class="image d-flex flex-row justify-content-center align-items-center">'+ 
                                    '<img class="mr-2" src="{{asset('assets/images/profile.jpg')}}" height="100" width="100" />'+ 
                                    '<img class="mr-2" src="{{asset('assets/images/profile.jpg')}}" height="100" width="100" />'+
                                    '<img class="mr-2" src="{{asset('assets/images/profile.jpg')}}" height="100" width="100" />'+
                                    '<img class="mr-2" src="{{asset('assets/images/profile.jpg')}}" height="100" width="100" />'+
                                ...
                                '<div class="container bg-white text-dark mt-2">'+
                                    ...
                                    '</div>'+          
                                '</div>'}, 'Childright', ''],
                                [{'v':'SuperSuper', 'f':'<div class="image d-flex flex-row justify-content-center align-items-center">'+ 
                                    '<img class="mr-2" src="{{asset('assets/images/profile.jpg')}}" height="100" width="100" />'+ 
                                    '<img class="mr-2" src="{{asset('assets/images/profile.jpg')}}" height="100" width="100" />'+
                                    '<img class="mr-2" src="{{asset('assets/images/profile.jpg')}}" height="100" width="100" />'+
                                    '<img class="mr-2" src="{{asset('assets/images/profile.jpg')}}" height="100" width="100" />'+
